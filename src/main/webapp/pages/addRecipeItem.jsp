...
<jsp:useBean id="addRecipeItemBean" type="pastryApp.web.AddRecipeItemBean" scope="request"/>
<html>
<head>
    <title>RecipeItems</title>
</head>
<body>
<form method="post" action="/add-recipe-item" enctype="application/x-www-form-urlencoded">
    <h1>Add cake part</h1>
    <p>Cake:
        <select name="cake">
